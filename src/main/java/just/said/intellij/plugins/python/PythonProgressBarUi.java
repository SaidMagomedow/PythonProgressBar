...
public class PythonProgressBarUi extends BasicProgressBarUI {
    ...
    private static final String PACKAGE_PATH = "/just/said/intellij/plugins/Python/";
    private final ScalableIcon CAT_ICON = (ScalableIcon) IconLoader.getIcon(PACKAGE_PATH + "rsz_snake.png",
            getClass().getClassLoader());
    private final ScalableIcon RCAT_ICON = (ScalableIcon) IconLoader.getIcon(PACKAGE_PATH + "rsz_snake.png",
            getClass().getClassLoader());
